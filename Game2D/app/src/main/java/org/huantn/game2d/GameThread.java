...
/*
 * Lớp GameSurface mô phỏng toàn bộ bề mặt của trò chơi,
 * class này mở rộng từ SurfaceView, SurfaceView chứa một đối tượng Canvas,
 * các đối tượng trong trò chơi sẽ được vẽ lên Canvas
 */
